...
export class AppComponent implements OnInit {
  ...
  createCakeFromService = (cake) => this._httpService.createItem(cake).subscribe(data => this.createResult = data)
  deleteCakesFromService = (id) => this._httpService.deleteItem(id).subscribe(data => this.deleteResult = data['data'])
  updateCakesFromService = (id, cake) => this._httpService.updateItem(id, cake).subscribe(data => this.updateResult = data)
